...
public class Regulator extends Actor
{
	...
	public Regulator(ArrayList<BugBot> b)
	{
		bugs = b;
		rockRow = 0;
		rockCol = 0;
	...
	public void placeBugsInGrid()
	{
		...
		for(int i = 0; i < bugs.size();i++)
		{
			...
			bugs.get(i).setDirection(dirs.remove(r));
                        ...
                        display.addBBAmmo(((BugBot2012)bugs.get(i)).getAmmo() + "");
	...
	public void stateWinner()
	{
		...
		else if(numDead == bugs.size()-1)
		{
			...
			System.out.println(alive.getName() + " is the winner");
                        ...
                        if(((BugBot2012)alive).getVictoryMusic()!=null)
                            Regulator.sound.playSongLoop(((BugBot2012)alive).getVictoryMusic());
	...
	public ArrayList<BugBot> sortedBattleBugs()
	{
		int max, maxPos;
		ArrayList<BugBot> sorted = new ArrayList<BugBot>();
