...
public class BugBot extends Bug {
    ...
    public BugBot(int s, int d, int sp, String n, Color co) {
        name = n;
        strength = s;
        defense = d;
        speed = sp;
    ...
    public void attack() {
        ...
        for (Location a : locs) {
            ...
            if ((equalDirections(dirTwds, dir) || equalDirections(dirTwds, dir - 45) || equalDirections(dirTwds, dir + 45))
                    && this.getGrid().get(a) instanceof BugBot) {
                locs2.add(a);
            }
        ...
        for (Location a : locs2) {
            if (((BugBot) (this.getGrid().get(a))).getDefense() <= strength - 3) {
                String kU = getGreatestStat(((BugBot) getGrid().get(a)));
                killUpgrade(kU);
    ...
    public String getGreatestStat(BugBot b) {
